...
const Slider = () => {    
  ...
  const columns = [
    ...
    { 
      ...
      renderCell: (params) => (
        <strong>
          <a href="javascript:void(0)" onClick={() => DeleteSlider(params.value)}><DeleteIcon/></a>
        </strong>
      ),
      disableClickEventBubbling: true
    }
  ...
  const logprint =  (data) => {console.log(data)}
  //<DeleteIcon/>
  useEffect(()=>{
    getImageList();
  },[]);
  ...
  function DeleteSlider(id) {
    console.log("Id: "+id);
    axios.post('http://localhost:5000/api/removeSliderImage',{
      'id': id
    ...
    <div>
      <div className="row">
        <div className="col-md-12 form-group">
          <div className="card">
            <div className="card-header"><h4><span><TuneIcon/></span>&nbsp;Slider</h4></div>
            <div className="card-body">
              <div className="row">
                ...
                <div className="col-md-6 form-group">
                  <input type="file" id="silderimg" onChange={onChange} className="form-control" />
